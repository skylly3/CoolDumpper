...
int __stdcall Decodeaddress(ulong addr,char *symb,int nsymb,char *comment) {
...
int __stdcall Printfloat4(char *s,float f) {
  int k;
...
int __stdcall Printfloat8(char *s,double d) {
  int k;
  ulong lod,hid;
  lod=((ulong *)&d)[0];
  hid=((ulong *)&d)[1];
...
int __stdcall Printfloat10(char *s,long double ext) {
  int k;
  char *e=(char *)&ext;
...
int __stdcall Print3dnow(char *s,char *f) {
  int n;
...
ulong __stdcall Disassembleback(uchar *block,ulong base,ulong size,ulong ip,int n) {
  int i;
...
ulong __stdcall Disassembleforward(uchar *block,ulong base,ulong size,ulong ip,int n) {
  int i;
  ulong cmdsize;
  uchar *pdata;
  t_disasm da;
...
int __stdcall Isfilling(ulong addr,char *data,ulong size,ulong align) {
