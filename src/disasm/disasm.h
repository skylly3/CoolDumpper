...
#ifdef BUILD_DLL
#define IMPORT_EXPORT extern "C" __declspec(dllexport) 
#else
...
IMPORT_EXPORT int    __stdcall Assemble(uchar *cmd,ulong ip,t_asmmodel *model,int attempt, int constsize,char *errtext);
...
IMPORT_EXPORT ulong  __stdcall Disasm(uchar *src,ulong srcsize,ulong srcip, t_disasm *disasm,int disasmmode);

IMPORT_EXPORT ulong  __stdcall Disassembleback(uchar *block,ulong base,ulong size,ulong ip,int n);
IMPORT_EXPORT ulong  __stdcall Disassembleforward(uchar *block,ulong base,ulong size,ulong ip,int n);
...
typedef ulong  (WINAPI *pfnDisasm)(uchar *src,ulong srcsize,ulong srcip,  t_disasm *disasm,int disasmmode);

typedef int    (WINAPI *pfnAssemble)(uchar *cmd,ulong ip,t_asmmodel *model,int attempt,int constsize,char *errtext);
